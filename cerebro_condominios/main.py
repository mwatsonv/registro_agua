...
from agentes.ingesta import crear_agente_ingesta
from agentes.prorrateo import crear_agente_prorrateo
from agentes.reportes import crear_agente_reportes
...
async def validar_y_guardar_lectura(
    ...
    try:
        ...
        # Instanciación bajo demanda por cada petición
        agente_ingesta = crear_agente_ingesta()
...
async def liquidar_y_guardar_mes(datos: dict):
    try:
        ...
        # Instanciación bajo demanda por cada petición
        agente_prorrateo = crear_agente_prorrateo()
...
async def generar_reportes_mes(datos_liquidacion: dict):
    try:
        ...
        # Instanciación bajo demanda por cada petición
        agente_reportes = crear_agente_reportes()
